        ...
        {analysisComplete && (
          <Card className="shadow-lg animate-fade-in">
            <CardHeader>
              ...
              <CardDescription>Multi-modal outputs generated by PrivAgent</CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  <div className="p-6 bg-slate-50 dark:bg-slate-900 rounded-lg">
                    ...
                    <div className="prose dark:prose-invert max-w-none">
                      ...
                      <p className="text-sm leading-relaxed mt-4">
                        ...
                        PrivAgent has identified a 12% revenue decline in the APAC region during Q3 2025. This decline is primarily 
...
`}
      ...
      <footer className="border-t border-slate-200 dark:border-slate-800 mt-12 py-8 bg-white/50 dark:bg-slate-900/50 backdrop-blur-sm">
        <div className="container mx-auto px-6 text-center">
          <p className="text-sm text-muted-foreground">
            PrivAgent - Privacy-Preserving Multi-Modal Business Analyst Agent
          </p>
